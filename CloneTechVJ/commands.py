...
async def start(client, message):
    ...
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        ...
        if cd["update_channel_link"] != None:
            ...
            buttons.append([InlineKeyboardButton('🍿 ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ 🍿 /n‣ ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ - @AkMoviesHubX </b>"', url=up)])
    ...
    if len(message.command) != 2:
        ...
        if cd["update_channel_link"] != None:
            up = cd["update_channel_link"]
            buttons.append([InlineKeyboardButton('🍿 ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ 🍿 /n‣ ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ @AkMoviesHubX', url=up)])
        reply_markup = InlineKeyboardMarkup(buttons)
    ...
    if data.startswith("sendfiles"):
        ...
        k = await client.send_message(chat_id=message.from_user.id,text=f"<b>Get All Files in a Single Click!!!\n\n📂 ʟɪɴᴋ ➠ : {g}\n\n<i>Note: This message is deleted in 5 mins to avoid copyrights. Save the link to Somewhere else</i>/n/n‣ ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ - @AkMoviesHubX</b>", reply_markup=InlineKeyboardMarkup(btn))
        ...
        k = await client.send_message(chat_id=user,text=f"<b>📕Nᴀᴍᴇ ➠ : <code>{files['file_name']}</code> \n\n🔗Sɪᴢᴇ ➠ : {get_size(files['file_size'])}\n\n📂Fɪʟᴇ ʟɪɴᴋ ➠ : {g}\n\n<i>Note: This message is deleted in 20 mins to avoid copyrights. Save the link to Somewhere else</i>/n/n‣ ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ - @AkMoviesHubX </b>", reply_markup=InlineKeyboardMarkup(btn))
        ...
        for file in files:
            ...
            if cd["update_channel_link"] != None:
                up = cd["update_channel_link"]
                button = [[
                    InlineKeyboardButton('🍿 ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ 🍿/n‣ ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ - @AkMoviesHubX</b>"', url=up)
                ]]
            ...
            filesarr.append(msg)
        k = await client.send_message(chat_id = message.from_user.id, text=f"<b><u>❗️❗️❗️IMPORTANT❗️️❗️❗️</u></b>\n\nThis Movie Files/Videos will be deleted in <b><u>10 mins</u> 🫥 <i></b>(Due to Copyright Issues)</i>.\n\n<b><i>Please forward this ALL Files/Videos to your Saved Messages and Start Download there</i>/n/n‣ ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ - @AkMoviesHubx</b>")
    ...
    if cd["update_channel_link"] != None:
        up = cd["update_channel_link"]
        button = [[
            InlineKeyboardButton('🍿 ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ 🍿/n‣ ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ @AkMoviesHubBackup"', url=up)
        ]]
        reply_markup=InlineKeyboardMarkup(button)
    else:
        reply_markup=None
    ...
    k = await msg.reply("<b><u>❗️❗️❗️IMPORTANT❗️️❗️❗️</u></b>\n\nThis Movie File/Video will be deleted in <b><u>10 mins</u> 🫥 <i></b>(Due to Copyright Issues)</i>.\n\n<b><i>Please forward this File/Video to your Saved Messages and Start Download there</i>/n/n‣ ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ @AkMoviesHubX</b>",quote=True)
    await asyncio.sleep(600)
    await msg.delete()
